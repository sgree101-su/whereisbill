...
def getuseraddress(): #Create dictionnary with user address
    address = {}
    address['street'] = input("Please enter your street address (no comma or special characters): ").replace(" ", "%20") + "&"
    address['city'] = input("Please enter your city (no comma or special characters): ").replace(" ", "%20") + "&"
    address['state'] = input("Please enter your state code (ex: NY for New York): ").replace(" ","%20") + "&"
    address['zipcode'] = input("Please enter your zipcode (ex: 13210): ") + "&"
...
while exit:
    ...
    if user_input == "quit":
        ...
        try:
            ...
            for i in bills:
                print("*****************************")
                print(color.BOLD + "Bill ID:" + color.END, i['bill_id'])
            ...
            while exit:
                ...
                if user_continue == "N":
                    ...
                    bill_tracking = getbillstatus(bill_id)
                    print("")
